...
public class CapturaPedidos2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_captura_pedidos2);

        TgBtnContado = (ToggleButton) findViewById(R.id.tgBtnContado);
        ...
        if(tipoventaDato.toString().equals("Mano")) {
            TgBtnContado.setVisibility(LinearLayout.VISIBLE);
        }
        else{
            TgBtnContado.setVisibility(LinearLayout.INVISIBLE);
        }

        productos = dbHandler.getProductos(familiaDato, subtipoDato); // Metodo que se trae la lista de productos de la tabla y la copia del array
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (opProducto16.length() >= 1) {
                    ...
                    if(cant16.toString() != "0" && cant16.toString() != "") {
                        if (tipo_venta.toString().equals("Mano")) {
                            //Invocamos el metodo para valida que haya exitencia de mano
                            String cve_cliente = "";
                            String[] separatedCliente = clienteDato.split("-");
                            cve_cliente = separatedCliente[0];
                ...
                if (opProducto23.length() >= 1) {
                    ...
                    //Validacion para la existencia en almacen de mano
                    if(cant23.toString() != "0" && cant23.toString() != "") {
                        if (tipo_venta.toString().equals("Mano")) {
                            //Invocamos el metodo para valida que haya exitencia de mano
                            String cve_cliente = "";
                            String[] separatedCliente = clienteDato.split("-");
                            ...
                            */
                                ...
                                Integer cantEnt = Integer.valueOf(cant23.getText().toString());
                                Integer existenciaEnt = Integer.parseInt(existencia);
                                ...
                                if (existenciaEnt < cantEnt) {
                                    ...
                                    cant23.setText("" + 0);
                                    total23.setText("");
                                    Toast toast = Toast.makeText(getApplicationContext(), "El producto en la partida 23 no tiene suficiente existencia en su almacen", Toast.LENGTH_SHORT);
                                    toast.show();
                                    return;
                                }
                            }
                ...
                if (opProducto24.length() >= 1) {
                    ...
                    //Validacion para la existencia en almacen de mano
                    if(cant24.toString() != "0" && cant24.toString() != "") {
                        if (tipo_venta.toString().equals("Mano")) {
                            //Invocamos el metodo para valida que haya exitencia de mano
                            String cve_cliente = "";
                            String[] separatedCliente = clienteDato.split("-");
                            ...
                            */
                                ...
                                if (existenciaEnt < cantEnt) {
                                    ...
                                    cant24.setText("" + 0);
                                    total24.setText("");
                                    Toast toast = Toast.makeText(getApplicationContext(), "El producto en la partida 24 no tiene suficiente existencia en su almacen", Toast.LENGTH_SHORT);
                                    toast.show();
                                    return;
                                }
                            }
                ...
                if (opProducto25.length() >= 1) {
                    ...
                    //Validacion para la existencia en almacen de mano
                    if(cant25.toString() != "0" && cant25.toString() != "") {
                        if (tipo_venta.toString().equals("Mano")) {
                            //Invocamos el metodo para valida que haya exitencia de mano
                            String cve_cliente = "";
                            String[] separatedCliente = clienteDato.split("-");
                            ...
                            */
                                ...
                                Integer cantEnt = Integer.valueOf(cant25.getText().toString());
                                Integer existenciaEnt = Integer.parseInt(existencia);
                                ...
                                if (existenciaEnt < cantEnt) {
                                    ...
                                    cant25.setText("" + 0);
                                    total25.setText("");
                                    Toast toast = Toast.makeText(getApplicationContext(), "El producto en la partida 25 no tiene suficiente existencia en su almacen", Toast.LENGTH_SHORT);
                                    toast.show();
                                    return;
                                }
                            }
                ...
                if (opProducto26.length() >= 1) {
                    ...
                    //Validacion para la existencia en almacen de mano
                    if(cant26.toString() != "0" && cant26.toString() != "") {
                        if (tipo_venta.toString().equals("Mano")) {
                            //Invocamos el metodo para valida que haya exitencia de mano
                            String cve_cliente = "";
                            String[] separatedCliente = clienteDato.split("-");
                            ...
                            */
                                ...
                                Integer cantEnt = Integer.valueOf(cant26.getText().toString());
                                Integer existenciaEnt = Integer.parseInt(existencia);
                                ...
                                if (existenciaEnt < cantEnt) {
                                    ...
                                    cant26.setText("" + 0);
                                    total26.setText("");
                                    Toast toast = Toast.makeText(getApplicationContext(), "El producto en la partida 26 no tiene suficiente existencia en su almacen", Toast.LENGTH_SHORT);
                                    toast.show();
                                    return;
                                }
                            }
                ...
                if (opProducto27.length() >= 1) {
                    ...
                    //Validacion para la existencia en almacen de mano
                    if(cant27.toString() != "0" && cant27.toString() != "") {
                        if (tipo_venta.toString().equals("Mano")) {
                            //Invocamos el metodo para valida que haya exitencia de mano
                            String cve_cliente = "";
                            String[] separatedCliente = clienteDato.split("-");
                            ...
                            */
                                ...
                                Integer cantEnt = Integer.valueOf(cant27.getText().toString());
                                Integer existenciaEnt = Integer.parseInt(existencia);
                                ...
                                if (existenciaEnt < cantEnt) {
                                    ...
                                    cant27.setText("" + 0);
                                    total27.setText("");
                                    Toast toast = Toast.makeText(getApplicationContext(), "El producto en la partida 27 no tiene suficiente existencia en su almacen", Toast.LENGTH_SHORT);
                                    toast.show();
                                    return;
                                }
                            }
                ...
                if (opProducto28.length() >= 1) {
                    ...
                    //Validacion para la existencia en almacen de mano
                    if(cant28.toString() != "0" && cant28.toString() != "") {
                        if (tipo_venta.toString().equals("Mano")) {
                            //Invocamos el metodo para valida que haya exitencia de mano
                            String cve_cliente = "";
                            String[] separatedCliente = clienteDato.split("-");
                            ...
                            */
                                ...
                                Integer cantEnt = Integer.valueOf(cant28.getText().toString());
                                Integer existenciaEnt = Integer.parseInt(existencia);
                                ...
                                if (existenciaEnt < cantEnt) {
                                    ...
                                    cant28.setText("" + 0);
                                    total28.setText("");
                                    Toast toast = Toast.makeText(getApplicationContext(), "El producto en la partida 28 no tiene suficiente existencia en su almacen", Toast.LENGTH_SHORT);
                                    toast.show();
                                    return;
                                }
                            }
                ...
                if (opProducto29.length() >= 1) {
                    ...
                    //Validacion para la existencia en almacen de mano
                    if(cant29.toString() != "0" && cant29.toString() != "") {
                        if (tipo_venta.toString().equals("Mano")) {
                            //Invocamos el metodo para valida que haya exitencia de mano
                            String cve_cliente = "";
                            String[] separatedCliente = clienteDato.split("-");
                            ...
                            */
                                ...
                                Integer cantEnt = Integer.valueOf(cant29.getText().toString());
                                Integer existenciaEnt = Integer.parseInt(existencia);
                                ...
                                if (existenciaEnt < cantEnt) {
                                    ...
                                    cant29.setText("" + 0);
                                    total29.setText("");
                                    Toast toast = Toast.makeText(getApplicationContext(), "El producto en la partida 29 no tiene suficiente existencia en su almacen", Toast.LENGTH_SHORT);
                                    toast.show();
                                    return;
                                }
                            }
                ...
                if (opProducto30.length() >= 1) {
                    ...
                    //Validacion para la existencia en almacen de mano
                    if(cant30.toString() != "0" && cant30.toString() != "") {
                        if (tipo_venta.toString().equals("Mano")) {
                            //Invocamos el metodo para valida que haya exitencia de mano
                            String cve_cliente = "";
                            String[] separatedCliente = clienteDato.split("-");
                            ...
                            */
                                ...
                                Integer cantEnt = Integer.valueOf(cant30.getText().toString());
                                Integer existenciaEnt = Integer.parseInt(existencia);
                                ...
                                if (existenciaEnt < cantEnt) {
                                    ...
                                    cant30.setText("" + 0);
                                    total30.setText("");
                                    Toast toast = Toast.makeText(getApplicationContext(), "El producto en la partida 30 no tiene suficiente existencia en su almacen", Toast.LENGTH_SHORT);
                                    toast.show();
                                    return;
                                }
                            }
...
//Invocamos el mettodo validaProductosFamilia para validar que los productos no se convinen de distintas familias
                ...
                ///***CUANDO EL SUBTIPO DE PEDIDO ES NORMAL
                if (subtipo.equals("Normal")) {

                    ///***CUANDO EL TIPO DE VENTA ES DE ALMACEN
                    if (tipo_venta.equals("Almacen")) {

                        ///TABLA DE PORCENTAJES DE DESCUENTO DE VETERINARIA
                        if (familia.equals("Veterinaria")) {
                            if (suma < 2666) {
                                porcentaje_desc = 0;
                            }
                            if (suma >= 2666 && suma <= 7273) {
                                porcentaje_desc = 40;
                            }
                            if (suma >= 7274 && suma <= 15239) {
                                porcentaje_desc = 45;
                            }
                            if (suma >= 15240 && suma <= 24001) {
                                porcentaje_desc = 47.5;
                            }
                            if (suma >= 24002) {
                                porcentaje_desc = 50;
                            }

                            ///PARA VERIFICAR SI SE ACTIVA ARMA TU OFERTA
                            String[] separated = opProducto1.split("-");
                            String cve_cat_producto = "";
                            cve_cat_producto = separated[0];
                            ...
                            // **************************************************
                            // MARR: Modificación para insertar el PAQUETE ANCLA
                            // 29/Mayo/2017 *************************************
                            if (cve_cat_producto.equals("13654")) {
                                porcentaje_desc = 45;
                            }

                        }
                        ///TABLA DE PORCENTAJES DE DESCUENTO DE AGRICOLA
                        if (familia.equals("Agricola")) {
                            if (suma < 2191) {
                                porcentaje_desc = 0;
                            }
                            if (suma >= 2191 && suma <= 10959) {
                                porcentaje_desc = 27;

                            }
                            if (suma >= 10960 && suma <= 20290) {
                                porcentaje_desc = 31;


                            }
                            if (suma >= 20291 && suma <= 30769) {
                                porcentaje_desc = 35;
                ...
                ///***CUANDO EL TIPO DE VENTA ES DE MANO
                if (tipo_venta.equals("Mano")) {
                    porcentaje_desc = 40;
                }

                ///***CUANDO EL SUBTIPO ES MUESTRAS GRATIS
                if (subtipo.equals("Muestras Gratis")) {
                    porcentaje_desc = 100;
                }
        ...
        btnSigGuardar.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                explicit_intent = new Intent(CapturaPedidos2.this,CapturaPedidosGuardar.class);
                ...
                // MARR: Modificación para insertar el PAQUETE ANCLA
                // 29/Mayo/2017 *************************************
                Boolean pedidoAncla = false;
                if (ProductoGuardar1.equals("13654- Paquete Ancla"))
                {
                    pedidoAncla = true;
                }
                ...
                if(ProductoGuardar1.toString().length() <= 0){
                    Toast toast = Toast.makeText(getApplicationContext(), "Debe capturar algun producto", Toast.LENGTH_SHORT);
                    toast.show();
                    return;
                }

                //Inicio para validar las piezas por paquete de los productos capturados
                /*
                if(tipoventaGuardar.toString().equals("Almacen")){

                    Integer piezas_acumuladas = 0;

                    //Se valida la primera partida para las piezas por paquete

                    if(ProductoGuardar1.length() > 0) {

                        String[] separated = ProductoGuardar1.split("-");
                        String cve_cat_producto = "";
                        cve_cat_producto = separated[0];
                        Integer cantidad = Integer.parseInt(CantidadGuardar1);
                        piezas_acumuladas += cantidad;

                        if (ProductoGuardar2.length() > 0) {
                            String[] separated2 = ProductoGuardar2.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                Integer cantidad2 = Integer.parseInt(CantidadGuardar2);
                                piezas_acumuladas += cantidad2;
                            }
                        }

                        if (ProductoGuardar3.length() > 0) {
                            String[] separated2 = ProductoGuardar3.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar3);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar4.length() > 0) {
                            String[] separated2 = ProductoGuardar4.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar4);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar5.length() > 0) {
                            String[] separated2 = ProductoGuardar5.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar5);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar6.length() > 0) {
                            String[] separated2 = ProductoGuardar6.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar6);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar7.length() > 0) {
                            String[] separated2 = ProductoGuardar7.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar7);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar8.length() > 0) {
                            String[] separated2 = ProductoGuardar8.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar8);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar9.length() > 0) {
                            String[] separated2 = ProductoGuardar9.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar9);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar10.length() > 0) {
                            String[] separated2 = ProductoGuardar10.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar10);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar11.length() > 0) {
                            String[] separated2 = ProductoGuardar11.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar11);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar12.length() > 0) {
                            String[] separated2 = ProductoGuardar12.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar12);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar13.length() > 0) {
                            String[] separated2 = ProductoGuardar13.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar13);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar14.length() > 0) {
                            String[] separated2 = ProductoGuardar14.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar14);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar15.length() > 0) {
                            String[] separated2 = ProductoGuardar15.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar15);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar16.length() > 0) {
                            String[] separated2 = ProductoGuardar16.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar16);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar17.length() > 0) {
                            String[] separated2 = ProductoGuardar17.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar17);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar18.length() > 0) {
                            String[] separated2 = ProductoGuardar18.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar18);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar19.length() > 0) {
                            String[] separated2 = ProductoGuardar19.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar19);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar20.length() > 0) {
                            String[] separated2 = ProductoGuardar20.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar20);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar21.length() > 0) {
                            String[] separated2 = ProductoGuardar21.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar21);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar22.length() > 0) {
                            String[] separated2 = ProductoGuardar22.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar22);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar23.length() > 0) {
                            String[] separated2 = ProductoGuardar23.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar23);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar24.length() > 0) {
                            String[] separated2 = ProductoGuardar24.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar24);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar25.length() > 0) {
                            String[] separated2 = ProductoGuardar25.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar25);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar26.length() > 0) {
                            String[] separated2 = ProductoGuardar26.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar26);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar27.length() > 0) {
                            String[] separated2 = ProductoGuardar27.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar27);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar28.length() > 0) {
                            String[] separated2 = ProductoGuardar28.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar28);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar29.length() > 0) {
                            String[] separated2 = ProductoGuardar29.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar29);
                                piezas_acumuladas += cantidad2;
                            }
                        }
                        if (ProductoGuardar30.length() > 0) {
                            String[] separated2 = ProductoGuardar30.split("-");
                            String cve_cat_producto2 = "";
                            cve_cat_producto2 = separated2[0];
                            if (cve_cat_producto == cve_cat_producto2) {
                                int cantidad2 = Integer.parseInt(CantidadGuardar30);
                                piezas_acumuladas += cantidad2;
                            }
                        }


                        Boolean pasa = dbHandler.piezasPaquete(cve_cat_producto, piezas_acumuladas);

                        if(pasa == false){
                            Toast toast = Toast.makeText(getApplicationContext(), "El producto "+ ProductoGuardar1 +" las piezas no correspoden a sus piezas por paquete", Toast.LENGTH_SHORT);
                            toast.show();
                            return;
                        }
                    ...
                    //Fin se valida la primera partida para las piezas por paquete

                }
                */
                //Fin para validar las piezas por paquete de los productos capturados

                String strTotal = String.valueOf(totalTotal.getText().toString());
                Double total_ver = Double.parseDouble(strTotal);
                ToggleButton TgBtnContado = (ToggleButton) findViewById(R.id.tgBtnContado);

                if(tipoventaDato.toString().equals("Almacen") && subtipoDato.toString().equals("Normal")){
                    // **************************************************
                    // MARR: Modificación para insertar el PAQUETE ANCLA
                    // 29/Mayo/2017 *************************************
                    if(total_ver < 1300 && !pedidoAncla){
                        Toast toast = Toast.makeText(getApplicationContext(), "El monto minimo es de 1300 en pedidos de almacen", Toast.LENGTH_SHORT);
                        toast.show();
                        return;
                    }
                    if(total_ver < 2600 && pedidoAncla){
                        Toast toast = Toast.makeText(getApplicationContext(), "El monto minimo con oferta Ancla es de 2600 en pedidos de almacen", Toast.LENGTH_SHORT);
                        toast.show();
                        return;
                    }
                ...
                if(tipoventaDato.toString().equals("Mano") && subtipoDato.toString().equals("Normal") && TgBtnContado.isChecked() == false){
                    if(total_ver < 800){
                        Toast toast = Toast.makeText(getApplicationContext(), "El monto minimo es de 800 en pedidos de mano", Toast.LENGTH_SHORT);
                        toast.show();
                        return;
                    }
                }
                if(tipoventaDato.toString().equals("Mano") && subtipoDato.toString().equals("Normal") && TgBtnContado.isChecked() == true){
                    if(total_ver < 500){
                        Toast toast = Toast.makeText(getApplicationContext(), "El monto minimo es de 500 en pedidos de mano", Toast.LENGTH_SHORT);
                        toast.show();
                        return;
                    }
                }
                ...
                /*
                AutoCompleteTextView activaOferta = (AutoCompleteTextView)findViewById(R.id.autoCompleteProducto1);
                String ActivaOferta = String.valueOf(activaOferta.getText().toString());
                String[] separated = ActivaOferta.split("-");
                String cve_cat_producto = "";
                cve_cat_producto = separated[0];

                if (total_ver < 3250 && cve_cat_producto.toString().equals("12591")){
                        Toast toast = Toast.makeText(getApplicationContext(), "El monto minimo es de 3250 en la oferta ARMA TU OFERTA", Toast.LENGTH_SHORT);
                        toast.show();
                        return;
                }
                */
