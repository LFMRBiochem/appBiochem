...
public class MainActivity extends AppCompatActivity {
    ...
    String[] Permisos=new String[] {permisoMemoria, permisoUbicacion1};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Si el dispositivo cuenta con la versión 6 de Android o superior, pregunta para obtener los permisos
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            /*
            // Verifica si existe el permiso para usar la ubicación del dispositivo
            ...
            // Verifica si existe el permiso para escribir en el almacenamiento interno del dispositivo
            if (ContextCompat.checkSelfPermission(MainActivity.this,
                    permisoMemoria)
                    != PackageManager.PERMISSION_GRANTED) {
