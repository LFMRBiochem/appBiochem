...
public class Autoupdater{
     ...
     */
    private static final String INFO_FILE = "http://www.sybrem.com.mx/adsnet/download/appbiochemmobile/version.txt";
    //private static final String INFO_FILE = "http://192.168.1.83/pruebas/version.txt";
    ...
    /**
     * Comentarios de las mejoras realizadas
     */
    ...
    private void getData() {
        try {
            ...
            mejoras=json.getString("mejoras");
    ...
    private AsyncTask<String, Integer, Intent> downloadInstaller = new AsyncTask<String, Integer, Intent>() {
        ...
        protected void onPreExecute()
        {
            ...
            pdDescarga = new ProgressDialog(context);
            pdDescarga.setTitle("Conectando a servidor Biochem...");
            pdDescarga.setMessage("Descargando aplicación, espere un momento...");
            pdDescarga.setCancelable(false);
            pdDescarga.show();
        ...
        protected Intent doInBackground(String... strings) {
            try {
                ...
                file.mkdirs();
                File outputFile = new File(file, "appBiochem.apk");
                ...
                intent.setDataAndType(Uri.fromFile(new File(Environment.getExternalStorageDirectory() + "/download/" + "appBiochem.apk")), "application/vnd.android.package-archive");
